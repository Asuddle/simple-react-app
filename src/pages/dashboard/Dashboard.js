	...
	render() {
		return (
			<div className={s.root}>
				<Row>
					<Col xl={4}>
						{/* <Widget title={<p style={{ fontWeight: 700 }}>Average Order Value</p>} customDropDown> */}
					...
					<Col xl={2} className={`${s.dashboardBlock}`} sm={6}>
						{/* <Widget> */}
						<Row className={`${s.row} justify-content-center align-items-center`}>
							...
							<Col sm={12} className={'d-flex justify-content-center align-items-center pt-1'}>
				...
				<Row>
					...
					<Col xl={4}>
						{/* <Widget title={<p style={{ fontWeight: 700 }}>Status</p>} customDropDown> */}
						<Row
